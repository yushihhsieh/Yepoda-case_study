...
Overview
This repository contains SQL scripts for managing and querying a database. The scripts are organized as follows:
...
2. All SQL scripts are written in PostgreSQL dialect.

3. Running SQL Scripts in Sequence
